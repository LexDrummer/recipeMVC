package ru.lexdrummer.recipemvc.bootstrap;

import org.springframework.context.ApplicationListener;
import org.springframework.context.event.ContextRefreshedEvent;
import org.springframework.stereotype.Component;
import ru.lexdrummer.recipemvc.domain.*;
import ru.lexdrummer.recipemvc.repositories.CategoryRepository;
import ru.lexdrummer.recipemvc.repositories.RecipeRepository;
import ru.lexdrummer.recipemvc.repositories.UnitOfMeasureRepository;
...
public class DataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        //Recipe of Guacamole
        Recipe recipeOfGuacamole = new Recipe();
        recipeOfGuacamole.setDescription("Perfect Guacamole");
        recipeOfGuacamole.setPrepTime(10);
        recipeOfGuacamole.setCookTime(0);
        recipeOfGuacamole.setDifficulty(Difficulty.EASY);
        recipeOfGuacamole.setDirections("1 Cut avocado, remove flesh: Cut the avocados in half. Remove seed. Score the inside of the avocado with a blunt knife and scoop out the flesh with a spoon" +
                "\n" +
